...
# for RTL-SDR
CXX += -DUSE_RTLSDR
LIBS += -lusb-1.0 -lrtlsdr -lliquid -lpthread

ft8mon: ft8.cc ft8mon.cc snd.cc libldpc.c osd.cc unpack.cc util.cc fft.cc cloudsdr.h cloudsdr.cc $(MOREC) $(MOREH)
	$(CXX) $(FLAGS) ft8mon.cc ft8.cc unpack.cc osd.cc snd.cc util.cc fft.cc libldpc.c cloudsdr.cc $(MOREC) -o ft8mon $(LIBS) -lportaudio
